...
export function Root(props: React.PropsWithoutRef<{ bootstrap: (setMiddlewares: React.Dispatch<React.SetStateAction<TMiddlewareState<any>[]>>) => void }>) {
  const [middlewares, setMiddlewares] = useState<TMiddlewareState<any>[]>([]);
